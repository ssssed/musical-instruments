...
const InstrumentList = () => {
  const allCard = [
    {
        id: 1,
        mainImg: 'https://celes.club/uploads/posts/2022-05/thumbs/1652759060_21-celes-club-p-muzikalnie-instrumenti-art-krasivo-25.jpg',
        imagesMini: [
            {
                id: 1,
    ...
    {
        id: 2,
        mainImg: 'https://celes.club/uploads/posts/2022-05/1652759094_22-celes-club-p-muzikalnie-instrumenti-art-krasivo-29.jpg',
        imagesMini: [
            {
                id: 4,
  ...
  return (
    <div className='instruments'>
        {allCard.map(card => (<InstrumentCard key={card.id} {...card} />))}
    </div>
  );
};
